#' Partisympati efter kön och utan/med barn (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_med_utan_barn <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "BarnUtanMed"=c("UB","MB","TOTALT"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201AR","ME0201AS"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati071",
