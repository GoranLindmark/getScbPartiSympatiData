#' Partisympati efter kön och civilstånd (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_civilstand <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "Civilstand"=c("OG","G","TOTALT"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201AN","ME0201AO"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati061",
