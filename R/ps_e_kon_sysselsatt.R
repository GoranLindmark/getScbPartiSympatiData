#' Partisympati efter kön och sysselsatt (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_sysselsatt <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "Sysselsatt"=c("SYS","EJSYS","ÖVR","TOT"),
         "Parti"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201BC","ME0201BD"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati12",
