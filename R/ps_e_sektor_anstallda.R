#' Partisympati efter sektor bland sysselsatta (urvalsundersökning). 2 ggr/år 2006M05 - 2021M05
#'
#' @import pxweb
#' @export
#'
ps_e_sektor_anstallda <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "SEI82"=c("11+12","21+22","11-22","33+36","46","56+57+60","33-60","76-89","99","Totalt"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201CJ","ME0201CK"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati112",
