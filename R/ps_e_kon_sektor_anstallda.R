#' Partisympati efter kön och sektor bland sysselsatta (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_sektor_anstallda <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "Sektor"=c("1-3B","4-5B","8","TOT"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201A3","ME0201A4"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati132",
