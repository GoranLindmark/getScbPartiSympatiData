#' Partisympati efter kön och utländsk/svensk bakgrund (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_utrikes_inrikes_bakgrund <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "UtlBakgrund"=c("1","2","TotalC"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201AP","ME0201AQ"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati18",
