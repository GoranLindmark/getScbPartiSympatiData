#' Partisympati efter kön och ålder, 7 åldersklasser (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_alder_7klasser <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "Alder"=c("18-24","25-34","35-44","45-54","55-64","65-74","75+","tot18+"),
         "Parti"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201AJ","ME0201AK"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati05",
