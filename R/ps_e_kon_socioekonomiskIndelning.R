#' Partisympati efter kön och socioekonomisk indelning (SEI) i väljarkåren (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_socioekonomiskIndelning <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "SEI82"=c("11+12","21+22","11-22","33+36","46","56+57+60","33-60","76","77+78","80","97","99-101","TOT"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201BE","ME0201BF"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati111",
