#' Partisympati efter kön och bostadstyp (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_bostadstyp <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "Bostadstyp"=c("1","2","3","5","TOTALT"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201AY","ME0201AZ"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati151",
