#' Partisympati efter kön och utrikes/inrikes född (urvalsundersökning).
#'
#' @import pxweb
#' @export
#'
ps_e_kon_utrikes_inrikes_fodd <- function( ) {
  
  pxweb_query_list <- 
    list("Kon"=c("1","2","TOT"),
         "UtrInrFodd"=c("110","113","99"),
         "Partisympati"=c("m","c","l","kd","nyd","mp","s","v","SD","övr"),
         "ContentsCode"=c("ME0201A9","ME0201A0"),
  ...
  px_data <- 
    pxweb_get(url = "http://api.scb.se/OV0104/v1/doris/sv/ssd/ME/ME0201/ME0201B/Partisympati19",
